...
public final class Keypad {
    ...
    static final KEYPROG[] KEYGRPS = {new KEYPROG(KeyEvent.VK_A, KeyEvent.KEY_LOCATION_STANDARD, 5, 6),
            ...
            new KEYPROG(KeyEvent.VK_ENTER, KeyEvent.KEY_LOCATION_NUMPAD, 1, 0),
            new KEYPROG(KeyEvent.VK_DECIMAL, KeyEvent.KEY_LOCATION_NUMPAD, 3, 0),
            new KEYPROG(KeyEvent.VK_PERIOD, KeyEvent.KEY_LOCATION_STANDARD, 3, 0),
